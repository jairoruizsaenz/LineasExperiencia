...
// load default chart
d3.csv("resources/data/data_03.csv", function(data){
...
function cleanTooltip(){
	...
	graph.svg.selectAll("#tooltip_03")
    	.remove();
}
...
function addTooltip(clicked, clickedCenPts){
	...
	graph.svg.selectAll("rect[id='tooltip_03']")
	...
	graph.svg.selectAll("text[id='tooltip_03']")
    	.data(clickedDataSet).enter()
    		.append("text")
